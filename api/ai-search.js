...
export default async function handler(req) {
  ...
  const gatewayKey = process.env.AI_Gateway_XP;
  if (!gatewayKey) return new Response(JSON.stringify({ error: 'AI_Gateway_XP not configured' }), { status: 500, headers: corsHeaders });
